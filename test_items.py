def test_guest_should_see_add_to_basket_button(browser):
    ...
    # Добавляем задержку для визуальной проверки языка (раскомментировать для проверки)
    # import time
    # time.sleep(30)
    
    # Проверяем наличие кнопки добавления в корзину
    # Используем более специфичный селектор для точности
    add_to_basket_button = browser.find_elements_by_css_selector(
